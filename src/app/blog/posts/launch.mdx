...
I've also written extensive [developer documentation](https://github.com/srleom/miniclue) to make contributing straightforward. If you'd like to work on a production-ready RAG codebase, this is the project for you.
...
MiniClue uses Gemini for lecture processing. And since Gemini has a generous free tier, most users can use MiniClue essentially **for free**.
