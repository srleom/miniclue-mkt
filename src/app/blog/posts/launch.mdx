...
I've also written extensive [developer documentation](https://github.com/miniclue/miniclue-info/blob/main/CONTRIBUTING.md) to make contributing straightforward. If you'd like to work on a production-ready RAG codebase, this is the project for you.
